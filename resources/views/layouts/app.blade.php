...
<body class="flex min-h-screen flex-col bg-zinc-950 text-zinc-100 antialiased selection:bg-amber-500 selection:text-zinc-950">
    <div class="mx-auto w-full max-w-7xl px-4 pt-6 sm:px-8 lg:px-12 lg:pt-8">
        <header class="flex flex-wrap items-center justify-between gap-4 border-b border-zinc-800/80 pb-6">
